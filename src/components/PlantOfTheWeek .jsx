...
const PlantOfTheWeek = () => {
  return (
    <section className="bg-green-50 dark:bg-black py-16 px-6 max-w-[1160px] mx-auto">
      <h2 className="text-3xl font-bold text-center text-green-700 mb-12">
        Plant of the Week
      </h2>

      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center bg-white rounded-2xl shadow-lg overflow-hidden  dark:bg-black">
