const PlantCare = () => {
  return (
    <section className="bg-gray-50 py-16 px-6 md:px-12 dark:bg-black">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-white rounded-3xl shadow-lg overflow-hidden dark:bg-black">
        ...
        <div className="md:w-1/2 p-8 md:p-12">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed dark:text-white">
