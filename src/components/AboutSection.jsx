    ...
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="p-6 bg-green-50 shadow rounded-xl text-center"
        >
          <h3 className="text-xl font-semibold text-green-700 mb-2">
            Fresh Indoor Plants
          </h3>
          <p className="text-gray-600">Handpicked, healthy, and ready to thrive.</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">Easy plant care tips for beginners to experts.</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">Stylish and sustainable pot collections.</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">Fast & safe delivery right to your doorstep.</p>
        </motion.div>
